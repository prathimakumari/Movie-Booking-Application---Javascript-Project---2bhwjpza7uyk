const API_KEY = 'api_key=0b9e9a5023535f05afb102db4dc6a741';
...
function showMovies(data){
    ...
    data.forEach(movie => {
        ...
        <div class="img-container">
             <img class="card-img" src="${IMG_URL+poster_path}" alt="${title}" onclick="popUpopen(this,${id})">
         </div>
         <div class="title">
